...
---
#### 5.2. 처리 우선순위에 따른 분류 (Maskable vs Non-Maskable)
...
---
#### 5.3. 인터럽트 및 예외 처리 순서 (Hardware Flow)
...
---
#### 5.4. 예외(Exception)와 인터럽트의 세부 구분
| 구분 | 종류 | 특징 | 복구 방식 |
| :--- | :--- | :--- | :--- |
